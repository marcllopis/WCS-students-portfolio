...
export const Vlada =
{
  english: {
    ...
    longDescription: [
      ...
      'This is just the beginning of my path in Tech industry, where I want to contribute and implement solutions. My experience has taught me to work under pressure and coordinate teamwork. I would love to bring everything learned to the needs of a company that allows me to continue growing and adding value wherever I go.',
    ],
    ...
    personalProjects: [
      {
        ...
        projectDescription: 'Games section for La Vanguardia focused on creating quality content to get users engagement to the page, through some strategies to get the objectives about encouraging readers  to recourege to the page',
  ...
  spanish: {
    ...
    longDescription: [
      ...
      'Esto solo es el comienzo de mi camino dentro del mundo de la tecnología, donde quiero aportar e implementar soluciones y mejoras. Mi experiencia me ha enseñado a trabajar bajo presión y coordinar trabajos en equipo. Me encantaría confluir todo lo aprendido a las necesidades de una empresa que me permita seguir creciendo y sumando valor allá donde vaya.',
    ],
    github: 'https://github.com/masko-vl',
    technologies: ['javascript', 'react', 'node', 'php', 'html', 'css', 'bootstrap', 'jquery', 'mysql', 'scrum'],
    personalProjects: [
      {
        ...
        projectGithub: 'https://github.com/LaVanguardia/LaVanguardia',
        projectLink: 'https://zen-shaw-4b92a9.netlify.app/',
        projectDescription: 'Creación de una sección de entretenimiento enfocada a crear contenido de calidad creando engagement a la página, a través de una serie de estrategias en forma de objetivos para fomentar la recurrencia del lector a la página',
        collaborators: ['Mireia Gomariz', 'Ailina Ozola', 'Julie Brosse'],
        technologies: ['react', 'node', 'mysql'],
      },
      {
